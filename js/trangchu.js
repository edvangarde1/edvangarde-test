window.onload = function () {
	...
	var tags = ["Giải tích", "Đại số", "Giáo trình", "Bài giảng"];
	...
	if (filters.length) { // có filter
		...
		addKhungSanPham('ĐẠI CƯƠNG - ĐẠI HỌC BÁCH KHOA HÀ NỘI', yellow_red, ['promo=giamgia'], soLuong, div);
		addKhungSanPham('BỔ TRỢ - ĐẠI HỌC BÁCH KHOA HÀ NỘI', blue, ['promo=moiramat', 'sort=rateCount-decrease'], soLuong, div);
		addKhungSanPham('PHÁP LUẬT VÀ LÝ LUẬN CHÍNH TRỊ', yellow_red, ['promo=tragop', 'sort=rateCount-decrease'], soLuong, div);
