    ...
    <div class="plc">
        <section>
            <ul class="flexContain">
                <li>Mở trang sách – Mở tương lai.</li>
                <li>Đọc đúng sách học đúng cách. </li>
                <li>Sách bạn cần – Giao tận tay.</li>
                <li>Gõ một cái – Sách tới tay.</li>
                <li>Hỗ trợ suốt thời gian sử dụng.
                    <br>Hotline:
                    <a href="tel:0965169300" style="color: #288ad6;">0965169300</a>
                </li>
            </ul>
        </section>
    </div>`);
